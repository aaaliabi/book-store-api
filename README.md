...
REST API для книжного магазина на Node.js, Express и Sequelize с базой PostgreSQL. Проект реализует CRUD для книг, категорий, прайс-листов и продаж, а также несколько raw-запросов. Документация доступна через Swagger UI.
